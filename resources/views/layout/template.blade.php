...
<head>
    ...
    <title>Komet {{date('Y')}} | @yield('title')</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-red elevation-4">
          ...
          <a href="#" class="brand-link bg-red">
            <img src="{{asset('assets/dist/img/Kometbulat.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text"><b>KOMET</b></span>
          </a>
        ...
        <footer class="main-footer">
          <strong>Copyright &copy; Kompetisi Matematika {{date('Y')}} | All rights reserved.</strong> 
